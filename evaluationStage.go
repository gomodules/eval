...
type (
	evaluationOperator     func(left interface{}, right interface{}, parameters Parameters) (interface{}, error)
	stageTypeCheck         func(value interface{}) bool
	stageCombinedTypeCheck func(left interface{}, right interface{}) bool
)
